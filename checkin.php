                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      ...
                                      <ul class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Check In</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="footer-select" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $data=mysqli_query($conn,"select * from `clientcleaninglog` WHERE clientID = '".$_SESSION['ClientID']."' Order by cleaning_logId DESC ");
                                                                    $counter = 0;
                                                                    while($row=mysqli_fetch_array($data)){
                                                                    ?>
                                                                    <tr>
                                                                        <td><?php echo ++$counter; ?></td>
                                                                        <td><?php $originalDate = $row[4]; echo    $newDate = date("d-m-Y g:i:s a", strtotime($originalDate)); ?> </td>
                                                                        <td><?php echo $row[2]; ?></td>
                                                                        <td><?php echo "<a target='_blank' href='checkinphoto?cleaning_logId=".$row[0]."' style='color:#4680ff;'>View Cleanner Photo</a>"; ?></td>
                                                                        <!--td><?php// echo '<img id="myImg" src="../../customervisit_data/CheckinPhotos/'.$row[3].'" alt="" width=100px/>'; ?></td-->
