                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="footer-select" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $data=mysqli_query($conn,"select * from `quantityrequest` where ClientID = '".$_SESSION['ClientID']."' order by QutityId DESC");
                                                                    $counter = 0;
                                                                    while($row=mysqli_fetch_array($data)){
                                                                    ?>
                                                                    <tr>
                                                                        <td><?php echo ++$counter; ?></td>
                                                                        <td><?php $originalDate = $row[6]; echo    $newDate = date("d-m-Y g:i:s a", strtotime($originalDate)); ?> </td>
