                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="footer-select" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $data=mysqli_query($conn,"select * from `clientcheckoutlog` INNER JOIN `Clients` ON clientcheckoutlog.checkIdID=Clients.ClientId order by clientcheckoutlog.checkoutId DESC");
                                                                    $counter = 0;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <!--td><a href='../../customervisit_data/CheckoutPhotos/<?php echo $row[2] ?>'  download><?php echo '<img id="" src="../../customervisit_data/CheckoutPhotos/'.$row[2].'" alt="" width=100px/>'; ?></a></td-->
                                                                        <td><?php if($row[3] != Null){ $originalDate = $row[3]; echo    $newDate = date("d-m-Y g:i:s a", strtotime($originalDate));} ?>
                                                                    </tr>
                                                                    <?php
                                                                    }
                                                                    ?>
