                                        	...
                                        	<div class="col-md-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>All Clients of Smart Cleaning</h5>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="footer-select" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody> 
                                                                    <?php 
                                                                    $data=mysqli_query($conn,"SELECT * FROM `Clients` LEFT JOIN subcontractordetails on Clients.ClientID = subcontractordetails.clientID WHERE Clients.Id != '".$_SESSION['Id']."'");
                                                                    $counter = 0;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php echo "<a href='client?Id=".$row[1]."' style='color:#4680ff;'>$row[1]</a>"; ?>
                                                                        </td>
