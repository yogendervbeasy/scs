        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            <nav class="navbar header-navbar pcoded-header" style="background-color:#160e3f; height:90px;">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-container container-fluid" style="background-color:#160e3f">
                        <ul class="nav-left">
                            <li>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    ...
                                    <div class="user-details">
                                        <p id="more-details"><?php echo $row['Name']; ?><i class="feather icon-chevron-down m-l-10"></i></p>
                                    </div>
                                </div>
                                <?php
                            	}
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                    ...
                                    <ul class="pcoded-submenu">
                                      ...
                                      <li class="">
                                        ...
                                        <li class="">
                                            <a href="representatives" class="waves-effect waves-dark">
                                                <span class="pcoded-mtext">Representatives</span>
                                            </a>
                                        </li>
                                          <li class="">
                                        ...
                                        <li class="">
                                            <a href="subcontractors" class="waves-effect waves-dark">
                                            <span class="pcoded-mtext">Subcontractors</span>
                                        </a>
                                        </li>
                                        <li class="">
                                            <a href="maintenance_requests" class="waves-effect waves-dark">
                                            <span class="pcoded-mtext">Maintenance Requests</span>
                                        </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <span class="pcoded-mtext">Raised Tickets</span>
                                </a>
                                <ul class="pcoded-submenu">
                                    <li class="">
