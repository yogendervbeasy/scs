                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="footer-select" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $data=mysqli_query($conn,"select * from `proofofservicedetails` INNER JOIN `Clients` ON proofofservicedetails.clientID=Clients.ClientId order by proofofservicedetails.pr_id DESC");
                                                                    $counter = 0;
